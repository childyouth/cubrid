...
#define MSGCAT_SYNTAX_INVALID_LEVEL                     MSGCAT_SYNTAX_NO(138)
#define MSGCAT_SYNTAX_NO_PRECISION_IN_SP_FUNCTION       MSGCAT_SYNTAX_NO(139)
...
#define MSGCAT_SEMANTIC_IDENTIFIER_IN_LIMIT_CLAUSE		MSGCAT_SEMANTIC_NO(317)
#define MSGCAT_SEMANTIC_SERIAL_NOT_OWNER                MSGCAT_SEMANTIC_NO(318)
#define MSGCAT_SEMANTIC_NOT_SUPPORTED_SP_ARG_TYPE		MSGCAT_SEMANTIC_NO(319)
#define MSGCAT_SEMANTIC_NOT_SUPPORTED_SP_RET_TYPE		MSGCAT_SEMANTIC_NO(320)
#define MSGCAT_SEMANTIC_NOT_ALLOWED_PERCENT_TYPE 		MSGCAT_SEMANTIC_NO(321)
...
#define MSGCAT_SEMANTIC_AU_GRANT_OPTION_NOT_ALLOWED             MSGCAT_SEMANTIC_NO(329)

#define MSGCAT_SEMANTIC_SP_PARAM_DEFAULT_STR_TOO_BIG            MSGCAT_SEMANTIC_NO(330)

#define MSGCAT_SEMANTIC_INVALID_HOST_EXPR               MSGCAT_SEMANTIC_NO(331)
#define MSGCAT_SEMANTIC_STORED_PROC_CALL_IN_SQL         MSGCAT_SEMANTIC_NO(332)
#define MSGCAT_SEMANTIC_SP_CALL_WITH_INTO_CLAUSE        MSGCAT_SEMANTIC_NO(333)

#define MSGCAT_SEMANTIC_VCLASS_ATT_CANT_SET_VISIBILITY            MSGCAT_SEMANTIC_NO(334)
#define MSGCAT_SEMANTIC_CLASS_ATT_OR_SHARED_CANT_SET_VISIBILITY         MSGCAT_SEMANTIC_NO(335)

#define MSGCAT_SEMANTIC_SCALE_OUT_OF_RANGE              MSGCAT_SEMANTIC_NO(336)

#define MSGCAT_SEMANTIC_UUID_INVALID_ARG                MSGCAT_SEMANTIC_NO(337)
#define MSGCAT_SEMANTIC_DEFAULT_UNCLASSIFIED_VOLATILITY MSGCAT_SEMANTIC_NO(338)
#define MSGCAT_SEMANTIC_DEFAULT_REQUIRES_PARENS         MSGCAT_SEMANTIC_NO(339)
